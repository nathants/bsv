...
def setup_module(m):
    ...
    shell.run('make clean && make bsv csv bsort bschema bsumeachhashu64', stream=True)
...
def test_basic():
    ...
    b,9
    """
    assert rm_whitespace(stdout) + '\n' == run(rm_whitespace(stdin), 'bsv | bschema *,a:u64 | bsumeachhashu64 | bschema *,u64:a | bsort | csv')
