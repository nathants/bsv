...
ALL=docs bbucket bcat bcounteach bcut bdedupe bdisjoint bdropuntil bpartition brsort bsort bsplit bsum bsv btake btakeuntil _copy _csv csv _gen_csv xxh3
