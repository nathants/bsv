...
ALL=docs bbucket bcat bcopy bcounteach bcountrows bcut bdedupe bdropuntil bmerge bpartition brmerge brsort bschema bsort bsplit bsum bsv btake btakeuntil _copy _csv csv _gen_bsv _gen_csv xxh3
