    ...
    do {                                                                                                                \
        while (1) {                                                                                                     \
            ...
            if (_csv_char_index - _csv_offset == _csv_bytes_read) {                                                     \
                ...
                _csv_offset--;                                                                                          \
                if (_csv_offset >= BUFFER_SIZE) {                                                                       \
                    fprintf(stderr, "error: line longer than BUFFER_SIZE\n");                                           \
                    exit(1);                                                                                            \
                }                                                                                                       \
...
#define WRITE_FLUSH(file)                                                       \
    do {                                                                        \
        if (_write_offset != fwrite(_write_buffer, 1, _write_offset, file)) {   \
