...
#define BYTES_UINT16_TO_INT32(src) (memcpy(&_util_uint16, src, 2), (int32_t)_util_uint16)
...
#define BYTES_UINT8_TO_INT32(src)  (memcpy(&_util_uint8, src, 1), (int32_t)_util_uint8)
