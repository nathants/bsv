...
#define MAP_KEY_BUF_SIZE 1024 * 512
...
#define MAP_INIT(map, type, initial_size)               \
    ...
    u64   map##_keys_buf_remaining = MAP_KEY_BUF_SIZE;  \

#define MAP_ALLOC(map, type)                            \
    MALLOC(map##_keys_buf, MAP_KEY_BUF_SIZE);           \
...
#define MAP_GROW_KEY_BUF(map)                                                        \
    do {                                                                            \
        map##_keys_buf_remaining = MAP_KEY_BUF_SIZE;                                \
